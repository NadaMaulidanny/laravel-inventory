              ...
              <div class="col-md-8 col-lg-12 mx-auto"> <!-- center & agak besar -->
                <div class="card">
                    <div class="card-header bg-secondary rounded-top">
                      <h4 style="color:white;" class="card-title mb-0">Form Edit Kategori</h4>
                    </div>
                  <div class="card-body">
                    <form action="{{route('kategori.kategoriUpdate', $kategori->id)}}" method="POST">
                      @csrf
                      @method('PUT')
                      <div class="col">
                        <!-- First & Last Name -->
